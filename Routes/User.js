...
router.post('/Register', async (req,res)=>{
    ...
    const user = new GreenUser({username:name,password:password,email:email,pushToken:pushToken,'homelocation.latitude':latitude,'homelocation.longitude':longitude})
